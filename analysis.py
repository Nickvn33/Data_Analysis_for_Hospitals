...
# hospital_df.loc[hospital_df.hospital == 'prenatal'].fillna('f', inplace=True)
hospital_df.loc[hospital_df.hospital == 'prenatal', 'gender'] = \
    hospital_df.loc[hospital_df.hospital == 'prenatal', 'gender'].fillna('f')
hospital_df.bmi.fillna(0, inplace=True)
hospital_df.diagnosis.fillna(0, inplace=True)
hospital_df.blood_test.fillna(0, inplace=True)
hospital_df.ecg.fillna(0, inplace=True)
hospital_df.ultrasound.fillna(0, inplace=True)
hospital_df.mri.fillna(0, inplace=True)
hospital_df.xray.fillna(0, inplace=True)
hospital_df.children.fillna(0, inplace=True)
hospital_df.months.fillna(0, inplace=True)
